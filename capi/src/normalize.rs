...
impl blaze_normalize_reason {
    ...
    pub const PERMITTED_ERROR: blaze_normalize_reason = blaze_normalize_reason(7);
}
...
impl From<Reason> for blaze_normalize_reason {
    fn from(reason: Reason) -> Self {
        match reason {
            ...
            Reason::PermittedError => blaze_normalize_reason::PERMITTED_ERROR,
            _ => unreachable!(),
        }
    }
}
...
pub extern "C" fn blaze_normalize_reason_str(reason: blaze_normalize_reason) -> *const c_char {
    match reason {
        ...
        blaze_normalize_reason::PERMITTED_ERROR => {
